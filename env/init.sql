...
('Qual é o número do Angel que Shinji enfrenta pela primeira vez no Eva-01?', 'Terceiro Angel', 'Quinto Angel', 'Quarto Angel', 'Segundo Angel', 'A'),
('Qual é a origem de Rei Ayanami na série?', 'Clonagem de Lilith', 'Experimento de fusão com um Angel', 'Mutação genética aleatória', 'Filha de Gendo', 'A'),
('Qual é o verdadeiro objetivo da organização Seele?', 'Controlar os Angels', 'Implementar o Projeto de Instrumentalidade Humana', 'Destruir todos os Evas', 'Controlar o governo japonês', 'B'),
('Quantos Evas são criados durante a série original?', 'Quatro', 'Cinco', 'Seis', 'Dois', 'C'),
('Qual é a função do Dummy Plug em um Eva?', 'Permitir que o Eva funcione sem piloto', 'Aumentar o poder do A.T. Field', 'Monitorar o Angel durante a batalha', 'Permitir o controle remoto do Eva', 'A'),
('Qual o motivo da rivalidade entre Asuka e Rei?', 'Diferenças de personalidade e origem', 'Ambas querem ser a líder dos pilotos', 'Rei trabalha contra Seele', 'Asuka suspeita de uma traição', 'A'),
('O que representa a cena final de *Evangelion*?', 'A conclusão do Projeto de Instrumentalidade Humana', 'Um futuro alternativo', 'A vitória contra os Angels', 'A destruição da humanidade', 'A'),
('Qual é o nome completo do piloto do Eva-02?', 'Misato Katsuragi', 'Shinji Ikari', 'Kaworu Nagisa', 'Asuka Langley Sohryu', 'E'),
('O que significa a expressão Third Impact?', 'A criação do primeiro Angel', 'O início da fusão das almas', 'O apocalipse causado pelos Angels', 'A ativação do Dummy Plug', 'C'),
('Por que Gendo Ikari tenta implementar o Projeto de Instrumentalidade?', 'Para unir a humanidade em um único ser', 'Para ganhar imortalidade', 'Para vingar a morte de Yui', 'Para obter o controle da Seele', 'A');
